...
import { Direction, Ordering } from "@/generated/graphql";

import { SimpleTable, SimpleTableProps, ValueType } from "../SimpleTable";
import { FilterType } from "../SimpleTable/enums/FilterType";
import { TagValueObjectType } from "../SimpleTable/interfaces/ValueObjectType";
import FilterDrawer from "./components/FilterDrawer";
import useRouteParamsState from "./hooks/useRouteParamsState";

const StyledQueryTable = styled.div`
  .ant-pagination-item {
    display: none;
  }
